...
def batch_handler(root_paths, target_suffix="_new", args=None, process_class=None):
    """
...
if __name__ == "__main__":
    root_paths = [GLOBAL_CONFIG["simple_path"] + r""]
    ...
    # 调用函数
    batch_handler(root_paths, process_class=Extracting)
